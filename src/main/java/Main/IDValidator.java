...
public class IDValidator {
    ...
    public static String checkDepartment(int id){
        if(id > 10000 && id < 11000) return "Production";
    ...
    public static boolean validateFromJSON(int id) throws IOException {
        ...
        try {
            File jsonFile = jsonFile = new File(path);
            ...
            switch (Objects.requireNonNull(department)) {
                ...
                case "Office" -> {
                    ...
                    contains = OfficeemployeeList.stream().anyMatch(p -> p.getID() == id);
                ...
                case "IT" -> {
                    ...
                    contains = ITemployeeList.stream().anyMatch(p -> p.getID() == id);
